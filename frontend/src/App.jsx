...
import QRCertificateGenerator from "./pages/CertificateCreation";
      ...
      <AuthProvider>
        <ToastProvider>
          <Routes>
            ...
            {/* <Route path="/bhoomi" element={<BhoomiLandingPage />} /> */}
              ...
              element={
                <ProtectedRoute>
                  <WithAuth>
                    {(user, logout) => (
                      <React.Suspense
                        fallback={<div>Loading event details...</div>}
                      >
                        <ErrorBoundary
                          fallback={
                            <div>Error loading event. Please try again.</div>
                          }
                        >
